            ...
            <div class="well">
                <form action="{{ url('/store-product') }}" method="POST" class="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <textarea name="short_description" id="Product_short_description" rows="3" class="form-control">{{$product->short_description}}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <textarea name="long_description" id="long_description" rows="10" class="form-control">{{$product->long_description}}</textarea>
